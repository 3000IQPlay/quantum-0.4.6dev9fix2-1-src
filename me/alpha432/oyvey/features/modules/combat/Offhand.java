...
import me.alpha432.oyvey.features.modules.client.ServerModule;
...
import me.alpha432.oyvey.mixin.mixins.accessors.IContainer;
import me.alpha432.oyvey.mixin.mixins.accessors.ISPacketSetSlot;
...
extends Module {
    ...
    public Setting<Float> gappleHealth = this.register(new Setting<Float>("GapHP", Float.valueOf(13.0f), Float.valueOf(0.1f), Float.valueOf(36.0f)));
    public Setting<Float> gappleHoleHealth = this.register(new Setting<Float>("GapHoleHP", Float.valueOf(3.5f), Float.valueOf(0.1f), Float.valueOf(36.0f)));
    public Setting<Bind> offHandCrystal = this.register(new Setting<Bind>("Crystal", new Bind(-1)));
    public Setting<Float> crystalHealth = this.register(new Setting<Float>("CryHP", Float.valueOf(13.0f), Float.valueOf(0.1f), Float.valueOf(36.0f)));
    public Setting<Float> crystalHoleHealth = this.register(new Setting<Float>("CryHoleHP", Float.valueOf(3.5f), Float.valueOf(0.1f), Float.valueOf(36.0f)));
    public Setting<Float> cTargetDistance = this.register(new Setting<Float>("CryDistance", Float.valueOf(10.0f), Float.valueOf(1.0f), Float.valueOf(20.0f)));
    public Setting<Bind> obsidian = this.register(new Setting<Bind>("Obsidian", new Bind(-1)));
    public Setting<Float> obsidianHealth = this.register(new Setting<Float>("ObbyHP", Float.valueOf(13.0f), Float.valueOf(0.1f), Float.valueOf(36.0f)));
    public Setting<Float> obsidianHoleHealth = this.register(new Setting<Float>("ObbyHoleHP", Float.valueOf(8.0f), Float.valueOf(0.1f), Float.valueOf(36.0f)));
    public Setting<Bind> webBind = this.register(new Setting<Bind>("Webs", new Bind(-1)));
    public Setting<Float> webHealth = this.register(new Setting<Float>("WebHP", Float.valueOf(13.0f), Float.valueOf(0.1f), Float.valueOf(36.0f)));
    public Setting<Float> webHoleHealth = this.register(new Setting<Float>("WebHoleHP", Float.valueOf(8.0f), Float.valueOf(0.1f), Float.valueOf(36.0f)));
    public Setting<Boolean> holeCheck = this.register(new Setting<Boolean>("HoleCheck", true));
    ...
    public Setting<Boolean> crystalToTotem = this.register(new Setting<Object>("CrystalTotem", Boolean.valueOf(true), v -> this.type.getValue() == Type.OLD));
    ...
    public Setting<Integer> serverTimeOut = this.register(new Setting<Integer>("ServerTimeout", 1000, 0, 5000));
    ...
    public void doSwitch() {
        ...
        if (this.currentMode == Mode2.GAPPLES && ((!EntityUtil.isSafe((Entity)Offhand.mc.player) || this.bedPlaceable()) && EntityUtil.getHealth((Entity)Offhand.mc.player, this.absorption.getValue()) <= this.gappleHealth.getValue().floatValue() || EntityUtil.getHealth((Entity)Offhand.mc.player, this.absorption.getValue()) <= this.gappleHoleHealth.getValue().floatValue()) || this.currentMode == Mode2.CRYSTALS && ((!EntityUtil.isSafe((Entity)Offhand.mc.player) || this.bedPlaceable()) && EntityUtil.getHealth((Entity)Offhand.mc.player, this.absorption.getValue()) <= this.crystalHealth.getValue().floatValue() || EntityUtil.getHealth((Entity)Offhand.mc.player, this.absorption.getValue()) <= this.crystalHoleHealth.getValue().floatValue()) || this.currentMode == Mode2.OBSIDIAN && ((!EntityUtil.isSafe((Entity)Offhand.mc.player) || this.bedPlaceable()) && EntityUtil.getHealth((Entity)Offhand.mc.player, this.absorption.getValue()) <= this.obsidianHealth.getValue().floatValue() || EntityUtil.getHealth((Entity)Offhand.mc.player, this.absorption.getValue()) <= this.obsidianHoleHealth.getValue().floatValue()) || this.currentMode == Mode2.WEBS && ((!EntityUtil.isSafe((Entity)Offhand.mc.player) || this.bedPlaceable()) && EntityUtil.getHealth((Entity)Offhand.mc.player, this.absorption.getValue()) <= this.webHealth.getValue().floatValue() || EntityUtil.getHealth((Entity)Offhand.mc.player, this.absorption.getValue()) <= this.webHoleHealth.getValue().floatValue())) {
            if (this.returnToCrystal.getValue().booleanValue() && this.currentMode == Mode2.CRYSTALS) {
                this.switchedForHealthReason = true;
            }
            this.setMode(Mode2.TOTEMS);
        }
        if (this.switchedForHealthReason && (EntityUtil.isSafe((Entity)Offhand.mc.player) && !this.bedPlaceable() && EntityUtil.getHealth((Entity)Offhand.mc.player, this.absorption.getValue()) > this.crystalHoleHealth.getValue().floatValue() || EntityUtil.getHealth((Entity)Offhand.mc.player, this.absorption.getValue()) > this.crystalHealth.getValue().floatValue())) {
            this.setMode(Mode2.CRYSTALS);
    ...
    private boolean noNearbyPlayers() {
        return this.mode == Mode.CRYSTALS && Offhand.mc.world.playerEntities.stream().noneMatch(e -> e != Offhand.mc.player && !OyVey.friendManager.isFriend((EntityPlayer)e) && Offhand.mc.player.getDistance((Entity)e) <= this.cTargetDistance.getValue().floatValue());
    }
    ...
    private boolean shouldTotem() {
        ...
        if (this.holeCheck.getValue().booleanValue() && EntityUtil.isInHole((Entity)Offhand.mc.player) && !this.bedPlaceable()) {
    ...
    private boolean bedPlaceable() {
        ...
        for (EnumFacing facing : EnumFacing.values()) {
            if (facing == EnumFacing.UP || facing == EnumFacing.DOWN || Offhand.mc.world.getBlockState(Offhand.mc.player.getPosition().offset(facing)).getBlock() != Blocks.BED && Offhand.mc.world.getBlockState(Offhand.mc.player.getPosition().offset(facing)).getBlock() != Blocks.AIR) continue;
            return true;
        }
        return false;
    }
