...
extends Module {
    private final Setting<Integer> blocksPerTick = this.register(new Setting<Integer>("BlocksPerTick", 20, 1, 20));
    ...
    private final Setting<Integer> disableTime = this.register(new Setting<Object>("DisableTime", Integer.valueOf(200), Integer.valueOf(50), Integer.valueOf(300), v -> this.disable.getValue()));
