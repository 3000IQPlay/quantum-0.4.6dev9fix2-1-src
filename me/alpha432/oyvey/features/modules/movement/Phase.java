...
extends Module {
    ...
    public Setting<Integer> xMove = this.register(new Setting<Object>("MoveX", Integer.valueOf(1), Integer.valueOf(1), Integer.valueOf(1000), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Integer> yMove = this.register(new Setting<Object>("MoveY", Integer.valueOf(1), Integer.valueOf(1), Integer.valueOf(1000), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Boolean> sneakpackets = this.register(new Setting<Object>("SneakPacket", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Boolean> extra = this.register(new Setting<Object>("ExtraPacket", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Integer> offset = this.register(new Setting<Object>("ExtraOffset", Integer.valueOf(1337), Integer.valueOf(-1337), Integer.valueOf(1337), v -> this.mode.getValue() == Mode.Phase && this.extra.getValue() != false));
    public Setting<Boolean> fallPacket = this.register(new Setting<Object>("FallPacket", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Boolean> teleporter = this.register(new Setting<Object>("Teleport", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Boolean> boundingBox = this.register(new Setting<Object>("BoundingBox", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Integer> teleportConfirm = this.register(new Setting<Object>("TPConfirm", Integer.valueOf(2), Integer.valueOf(0), Integer.valueOf(4), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Boolean> ultraPacket = this.register(new Setting<Object>("DoublePacket", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Boolean> updates = this.register(new Setting<Object>("Update", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Boolean> setOnMove = this.register(new Setting<Object>("SetMove", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Boolean> cliperino = this.register(new Setting<Object>("NoClip", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.Phase && this.setOnMove.getValue() != false));
    public Setting<Boolean> scanPackets = this.register(new Setting<Object>("ScanPackets", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Boolean> resetConfirm = this.register(new Setting<Object>("Reset", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Boolean> posLook = this.register(new Setting<Object>("PosLook", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.Phase));
    public Setting<Boolean> cancel = this.register(new Setting<Object>("Cancel", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.Phase && this.posLook.getValue() != false));
    public Setting<Boolean> cancelType = this.register(new Setting<Object>("SetYaw", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.Phase && this.posLook.getValue() != false && this.cancel.getValue() != false));
    public Setting<Boolean> onlyY = this.register(new Setting<Object>("OnlyY", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.Phase && this.posLook.getValue() != false));
    public Setting<Integer> cancelPacket = this.register(new Setting<Object>("Packets", Integer.valueOf(20), Integer.valueOf(0), Integer.valueOf(20), v -> this.mode.getValue() == Mode.Phase && this.posLook.getValue() != false));
    ...
    public Setting<Boolean> flight = this.register(new Setting<Object>("Flight", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Integer> flightMode = this.register(new Setting<Object>("FMode", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(1), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Boolean> doAntiFactor = this.register(new Setting<Object>("Factorize", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Double> antiFactor = this.register(new Setting<Object>("AntiFactor", Double.valueOf(1.0), Double.valueOf(0.1), Double.valueOf(3.0), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Double> extraFactor = this.register(new Setting<Object>("ExtraFactor", Double.valueOf(1.0), Double.valueOf(0.1), Double.valueOf(3.0), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Boolean> strafeFactor = this.register(new Setting<Object>("StrafeFactor", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Integer> loops = this.register(new Setting<Object>("Loops", Integer.valueOf(1), Integer.valueOf(1), Integer.valueOf(10), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Boolean> clearTeleMap = this.register(new Setting<Object>("ClearMap", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Integer> mapTime = this.register(new Setting<Object>("ClearTime", Integer.valueOf(30), Integer.valueOf(1), Integer.valueOf(500), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Boolean> clearIDs = this.register(new Setting<Object>("ClearIDs", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Boolean> setYaw = this.register(new Setting<Object>("SetYaw", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Boolean> setID = this.register(new Setting<Object>("SetID", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Boolean> setMove = this.register(new Setting<Object>("SetMove", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Boolean> nocliperino = this.register(new Setting<Object>("NoClip", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Boolean> sendTeleport = this.register(new Setting<Object>("Teleport", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Boolean> resetID = this.register(new Setting<Object>("ResetID", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Boolean> setPos = this.register(new Setting<Object>("SetPos", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.Packetfly));
    public Setting<Boolean> invalidPacket = this.register(new Setting<Object>("InvalidPacket", Boolean.valueOf(true), v -> this.mode.getValue() == Mode.Packetfly));
    ...
    public void onUpdate() {
        if (this.sneakpackets.getValue().booleanValue()) {
    ...
    public void onMove(MoveEvent event) {
        if (this.mode.getValue() == Mode.Phase) {
            if (this.setOnMove.getValue().booleanValue() && event.getStage() == 0 && !mc.isSingleplayer() && this.mode.getValue() == Mode.Phase) {
        ...
        if (this.mode.getValue() == Mode.Packetfly && this.setMove.getValue().booleanValue() && this.flightCounter != 0) {
            event.setX(Phase.mc.player.motionX);
            event.setY(Phase.mc.player.motionY);
            event.setZ(Phase.mc.player.motionZ);
    ...
    public void onMove(UpdateWalkingPlayerEvent event) {
        if (this.mode.getValue() == Mode.Phase) {
            if (Phase.fullNullCheck() || event.getStage() != 0 || this.mode.getValue() != Mode.Phase) {
                return;
            }
        ...
        if (this.mode.getValue() == Mode.Packetfly) {
            ...
            double d = Phase.mc.player.movementInput.jump && (checkCollisionBoxes || !EntityUtil.isMoving()) ? (this.flight.getValue().booleanValue() && !checkCollisionBoxes ? (this.flightMode.getValue() == 0 ? (this.resetCounter(10) ? -0.032 : 0.062) : (this.resetCounter(20) ? -0.032 : 0.062)) : 0.062) : (Phase.mc.player.movementInput.sneak ? -0.062 : (!checkCollisionBoxes ? (this.resetCounter(4) ? (this.flight.getValue().booleanValue() ? -0.04 : 0.0) : 0.0) : (speed = 0.0)));
            ...
            for (int i = 1; i < this.loops.getValue() + 1; ++i) {
                Phase.mc.player.motionX = strafing[0] * (double)i * this.extraFactor.getValue();
                Phase.mc.player.motionY = speed * (double)i;
                Phase.mc.player.motionZ = strafing[1] * (double)i * this.extraFactor.getValue();
    ...
    private void doPhase(MoveEvent event) {
        if (this.mode.getValue() == Mode.Phase) {
            if (!this.boundingBox.getValue().booleanValue()) {
                ...
                this.teleport = this.teleporter.getValue() == false || !this.teleport;
    ...
    public void onPacketReceive(PacketEvent.Receive event) {
        if (this.mode.getValue() == Mode.Phase && this.posLook.getValue().booleanValue() && event.getPacket() instanceof SPacketPlayerPosLook) {
        ...
        if (this.mode.getValue() == Mode.Packetfly && event.getPacket() instanceof SPacketPlayerPosLook && !Phase.fullNullCheck()) {
            BlockPos pos;
            SPacketPlayerPosLook packet = (SPacketPlayerPosLook)event.getPacket();
            if (Phase.mc.player.isEntityAlive() && Phase.mc.world.isBlockLoaded(pos = new BlockPos(Phase.mc.player.posX, Phase.mc.player.posY, Phase.mc.player.posZ), false) && !(Phase.mc.currentScreen instanceof GuiDownloadTerrain) && this.clearIDs.getValue().booleanValue()) {
    ...
    public void onPacketReceive(PacketEvent.Send event) {
        if (this.mode.getValue() == Mode.Phase && this.scanPackets.getValue().booleanValue() && event.getPacket() instanceof CPacketPlayer) {
