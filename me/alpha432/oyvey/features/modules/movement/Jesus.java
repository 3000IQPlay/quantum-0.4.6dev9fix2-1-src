...
import me.alpha432.oyvey.event.events.JesusEvent;
...
extends Module {
    ...
    public Setting<Boolean> fall = this.register(new Setting<Object>("NoFallOldfag", Boolean.valueOf(false), v -> this.mode.getValue() == Mode.TRAMPOLINE));
