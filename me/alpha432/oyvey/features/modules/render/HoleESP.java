...
extends Module {
    ...
    private final Setting<Integer> range = this.register(new Setting<Integer>("RangeX", 5, 0, 20));
    private final Setting<Integer> rangeY = this.register(new Setting<Integer>("RangeY", 5, 0, 20));
    public Setting<Boolean> newGradient = this.register(new Setting<Boolean>("NewGradient", false));
    ...
    public HoleESP() {
        super("HoleESP", "he", Module.Category.RENDER, false, false, false);
        this.setInstance();
    }
