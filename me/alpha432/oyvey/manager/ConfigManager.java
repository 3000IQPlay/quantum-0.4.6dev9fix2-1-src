...
implements Util {
    ...
    public void loadConfig(String name) {
        List files = Arrays.stream((Object[])Objects.requireNonNull(new File("Quantum").listFiles())).filter(File::isDirectory).collect(Collectors.toList());
        this.config = files.contains(new File("Quantum/" + name + "/")) ? "Quantum/" + name + "/" : "Quantum/config/";
